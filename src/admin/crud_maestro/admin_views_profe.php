        ...
        <div class="flex h-full bg-gray-900 text-white w-60  py-6 flex-col justify-between">
            <div class="px-6">
                ...
                <div class="mt-6 space-y-2">
                    ...
                    <a href="./admin_views_profe.php" class=" flex flex-row justify-center  group">
            ...
            <section class=" h-screen bg-blue-50">
                <div class="flex  w-full flex-row justify- items-center    ">
                    <div class="flex h-10 w-full  flex-row justify-between items-center">
                        <h1 class="text-2xl text-gray-500"> Lista de Maestro </h1>
                        <div>
                        ...
                        <div class="bg-white p-8 rounded shadow-lg w-1/2">
                            ...
                            <form action="./agregar_profe.php" method="POST">
                                <div class="mb-2">
                                    ...
                                    <input type="email" id="email" name="email" placeholder="Ingresa el correo electrónico" class="w-full border px-3 py-2 rounded focus:outline-none focus:ring focus:border-blue-300">
                                </div>
                                <div class="mb-2">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" id="apellido" name="apellido" placeholder="Ingresa los apellidos" class="w-full border px-3 py-2 rounded focus:outline-none focus:ring focus:border-blue-300">
                                </div>
                                <div class="mb-2">
                        ...
                        <div class="bg-white p-8 rounded shadow-lg w-1/2">
                            ...
                            <form action="./editar_profe.php" method="POST">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="email" id="editCorreo" name="editCorreo" class="w-full border px-3 py-2 rounded focus:outline-none focus:ring focus:border-blue-300">
                                </div>
                                <div class="mb-2">
                                    <label for="editNombre" class="block font-medium">Nombre(s):</label>
                                    <input type="text" id="editNombre" name="editNombre" class="w-full border px-3 py-2 rounded focus:outline-none focus:ring focus:border-blue-300">
                                </div>
                                <div class="mb-2">
                                    <label for="editApellidos" class="block font-medium">Apellidos:</label>
                                    <input type="text" id="editApellidos" name="editApellidos" class="w-full border px-3 py-2 rounded focus:outline-none focus:ring focus:border-blue-300">
                                </div>
                                <div class="mb-2">
                                    <label for="editDireccion" class="block font-medium">Direccion:</label>
                                    <input type="text" id="editDireccion" name="editDireccion" class="w-full border px-3 py-2 rounded focus:outline-none focus:ring focus:border-blue-300">
                                </div>
                                <div class="mb-2">
                                    <label for="editfecha_nacimiento" class="block font-medium">Fecha de
                                        Nacimiento:</label>
                                    <input type="date" id="editfecha_nacimiento" name="editfecha_nacimiento" class="w-full border px-3 py-2 rounded focus:outline-none focus:ring focus:border-blue-300">
                                </div>
                                <div class="flex justify-end gap-2 mt-6">
