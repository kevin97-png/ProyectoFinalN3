    ...
    <div class=" flex justify-center items-center w-screen">
        <div class="bg-white p-8 rounded shadow-lg w-9/12">
            <div class="flex justify-between">
                <a href="./perfil_admin.php" class="mb-5 flex items-center justify-center bg-gray-900 text-white px-4 w-20 py-2 rounded hover:bg-blue-600">Back</a>
            </div>
            <h2 class="text-2xl font-semibold mb-4">Editar perfil</h2>
            <form action="./editar_perfil_admin.php" method="POST" class="w-full">
                <div class="mb-4">
