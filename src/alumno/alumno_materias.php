    ...
    <div class="w-screen h-screen flex">
        <div class="flex h-full bg-gray-900 text-white w-60  py-6 flex-col justify-between">
            <div class="px-6">
                ...
                <div class="border-t border-gray-800 mb-2 pt-4 text-sm">Alumno <br> <span> Nombre</span></div>
                <div class="border-t border-gray-800 pt-4 text-sm uppercase flex items-center justify-center">Menu Alumno</div>
                <div class="mt-6 space-y-2">
                    <div class="  ">
                        <ul class="">
                            <li class=" "><a href="./Views_calificacion.php"> Ver Calificaciones</a> </li>
