    ...
    <div class="w-screen h-screen flex">
        <div class="flex h-full bg-gray-900 text-white w-60  py-6 flex-col justify-between">
            <div class="px-6">
                ...
                <div class="border-t border-gray-700 pt-4 text-sm ">Menu Maestro</div>
                    ...
                    <button id="buttonToggle" class="relative flex justify-center items-center group">
                        ...
                        <div id="toggleMenu" class=" absolute top-full min-w-full w-max bg-white mt-1 rounded hidden">
                            ...
                            <ul class="text-left border none">
                                ...
                                <li class="px-4 py-1 border-b flex flex-row gap-3"> <i class="mr-3 fa-solid fa-user"></i>
                                    Perfil </li>
                                    </a>
                            ...
                            <div class="bg-white p-8 rounded shadow-lg w-1/2">
                                ...
                                <form action="./editar_alumno.php" method="POST">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="number" id="calificacion" name="calificacion" class="w-full border px-3 py-2 rounded focus:outline-none focus:ring focus:border-blue-300">
                                    </div>
                                    <div class="mb-2">
                                        <label for="mensaje" class="block font-medium">Editar Mensaje</label>
                                        <input type="text" id="mensaje" name="mensaje" class="w-full border px-3 py-2 rounded focus:outline-none focus:ring focus:border-blue-300">
                                    </div>
                                    <div class="flex justify-end gap-2 mt-6">
                                        <button type="button" class="bg-gray-400 text-white px-4 py-2 rounded hover:bg-gray-500" onclick="cerrarModal()">Cerrar</button>
                                        <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600" id="createBtn">Editar</button>
                                    </div>
                                </form>
                            </div>
                        </div>
